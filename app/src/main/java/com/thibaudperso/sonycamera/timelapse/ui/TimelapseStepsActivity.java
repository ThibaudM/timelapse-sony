...
public class TimelapseStepsActivity extends AppCompatActivity implements StepCompletedListener, WifiListener,
...
//        informationTextView.setText(fragment.getInformation());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        previousItem.setVisible(mPager.getCurrentItem() > 0 &&
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_next:
                if (mPager.getCurrentItem() == mPagerAdapter.getCount() - 1) {
                    ...
                    CameraAPI mCameraAPI = ((TimelapseApplication) this.getApplication()).getCameraAPI();
                    if (mCameraAPI != null)
                        mCameraAPI.closeConnection();
